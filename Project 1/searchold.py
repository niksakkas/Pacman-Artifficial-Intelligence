...
def depthFirstSearch(problem):
    ...
    # print("Is the start a goal?", problem.isGoalState(goal),"\n")
    # while problem.goal != problem.startState:
    #     successors = problem.getSuccessors(problem.startState)
    #     #don't go back unless you have too
    #     if len(successors) != 1:
    #         new = random.choice(successors)
    #         while 1 != 0:
    #             if new[1] == "North" and old[1] == "South":
    #                 new = random.choice(successors)
    #             elif new[1] == "South" and old[1] == "North":
    #                 new = random.choice(successors)
    #             elif new[1] == "West" and old[1] == "East":
    #                 new = random.choice(successors)
    #             elif new[1] == "East" and old[1] == "West":
    #                 new = random.choice(successors)
    #             else:
    #                 break
    #     else:
    #         new = successors[0]
    #     problem.startState = new[0]
    #     directions.push(new[1])
    #     node_sequence.push(new[0])
    #     old = new
    #
    #
    # #find and clear circles of the path you found
    # for start_of_circle in range(len(node_sequence.list)):
    #     for iterator in range(start_of_circle,len(node_sequence.list)):
    #         if node_sequence.list[start_of_circle] == node_sequence.list[iterator]:
    #             end_of_circle = iterator
    #     if node_sequence.list[start_of_circle:end_of_circle] != []:
    #         del node_sequence.list[start_of_circle:end_of_circle]
    #         del directions.list[start_of_circle+1:end_of_circle+1]
